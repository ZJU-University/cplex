...
if __name__ == '__main__':
    ...
    # 参数定义
    max_stu_in = 3500.0  # 最大招收学生数量
    max_stu_out = 600.0  # 最大退学学生数量
    local_stu_tuition = 7600.0  # 本州学生学费
    nonlocal_stu_tuition = 22500.0  # 本州学生学费
    ...
    constraints_lefts = [
        ...
        [['local_stu', 'nonlocal_stu'], [max_nonlocal_rt, max_nonlocal_rt-1.0]],
    ]  # 约束条件左边
